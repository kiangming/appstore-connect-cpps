...
export interface MatrixFilterBarProps {
  ...
  currencyFilter: string; // "ALL" sentinel or an ISO 4217 code
      ...
      <div className="flex items-center gap-3 mb-3 flex-wrap">
        <div className="flex-1 min-w-[220px] max-w-md relative">
          ...
          <input
            ...
            placeholder="Search market — country name or code"
            className="w-full pl-9 pr-3 py-2 text-sm border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition"
          />
        </div>
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="text-sm border border-slate-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition"
          >
        ...
        {CONTINENTS.map((continent) => {
          ...
          return (
            ...
            >
              ...
              <span className={on ? "text-emerald-600" : "text-slate-400"}>
                ({count})
              </span>
            </button>
          );
