...
/**
 * Part 3 (enabled-toggle-reverting investigation): confirms the toggle's
 * initial UI state reflects the persisted `enabled` value from the server
 * (not a default), and that saving with a blank token (Part 2's reported
 * bug) still submits the CURRENT toggle state rather than silently
...
describe("HubTrackingClient — enabled toggle reflects persisted state, not a default", () => {
