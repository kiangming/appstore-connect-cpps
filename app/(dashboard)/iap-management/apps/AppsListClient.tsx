...
function AppCard({ app }: { app: App }) {
  return (
    <Link
      href={`/iap-management/apps/${app.id}`}
...
export function AppsListClient({ apps }: { apps: App[] }) {
    ...
    <div className="space-y-6">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-3 py-2.5 rounded-xl border border-slate-200 bg-white text-sm placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#0071E3] focus:border-transparent transition"
        />
      </div>
