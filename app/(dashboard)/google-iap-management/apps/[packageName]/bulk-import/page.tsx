...
import { BulkImportWizard } from "@/components/google-iap-management/bulk-import/BulkImportWizard";
  ...
  return (
    <div className="p-8 max-w-5xl">
      ...
      <p className="text-sm text-slate-500 mb-6">
        <span className="font-mono text-emerald-700">{packageName}</span> · upload the Manager template to create / update many IAPs in one batch.
      </p>
      <BulkImportWizard
        ...
        appDefaultLanguage={app.default_language}
      />
    </div>
  );
}
